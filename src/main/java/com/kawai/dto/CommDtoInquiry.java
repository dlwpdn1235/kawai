...
public class CommDtoInquiry {
	...
	public CommDtoInquiry(int inquiry_id, String inquiry_title, String inquiry_content, String inquiry_date,
			int user_id, String user_name, String user_eamil, int market_id, String market_title,
	...
	public String toString() {
		return "CommDtoInquiry [inquiry_id=" + inquiry_id + ", inquiry_title=" + inquiry_title + ", inquiry_content="
				+ inquiry_content + ", inquiry_date=" + inquiry_date + ", user_id=" + user_id + ", user_name="
				+ user_name + ", user_eamil=" + user_eamil + ", market_id=" + market_id + ", market_title="
				+ market_title + ", inquiry_category_id=" + inquiry_category_id + ", inquiry_category="
				+ inquiry_category + ", isAnswer=" + isAnswer + "]";
	}
