		...
		<div class="col-sm-2" style="position: sticky; top: 100px;">
			...
			<div class="well">
				...
				<table class="table table-striped table-hover commListTable">
					...
					<thead>
						<tr>
							<th scope="col" class="text-center">숨김 여부</th>
							<th scope="col" class="text-center">카테고리</th>
							<th scope="col" class="text-center">제목</th>
							<th scope="col" class="text-center">작성자</th>
							<th scope="col" class="text-center">날짜</th>
							<th scope="col" class="text-center">조회수</th>
							<th scope="col" class="text-center">숨김 버튼</th>							
						</tr>
					</thead>
					<tbody>
	  ...
	  var isLoading = false; // 데이터 로딩 여부
		...
		$("#searchbtn").on("click",function(){
	  	...
	  	function commList(){
	  		...
	  		$.ajax({
	  			url : "${pageContext.request.contextPath}/community/commAjaxAdminView",
	  			type : "POST",
	  	...
	  	function commListResult(json){
	  		...
	  		$.each(json.commList, function(idx, commList){
				...
				.append($("<td>").append($("<input type='button' class='btn btn-info hideBtn' value='숨김'/>")))
