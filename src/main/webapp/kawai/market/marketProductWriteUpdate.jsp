...
<%@include file="../inc/header.jsp" %>
   <div class="container panel tmpt">
      <h3 class="panel-heading">마켓수정</h3>   
		   ...
		   <div class="form-group">
		    ...
		    <div class="marketWriteTitle marketWriteCon">
		    	<label for="mTitle">제목</label>
		   		<input type="text" name="mTitle" class="form-control" value="${market.MTitle}"/>
		   </div>
			<div class="form-group bookapi">
    				<label for="search"  >책 검색</label>
					<input type="search" name="search" id="search" class="form-control" value="${market.bookinfo.book_title}"/>
			...
			<div class="form-group bookinfo">
				...
				<input type="text" name="book_title" class="form-control" value="${market.bookinfo.book_title}" readonly>
				<label for="book_image">이미지</label>
				<input type="text" name="book_image" class="form-control" value="${market.bookinfo.book_image}" readonly>
				<label for="book_author">저자</label>
				<input type="text" name="book_author" class="form-control" value="${market.bookinfo.book_author}" readonly>
				<label for="book_publisher">퍼블리셔</label>
				<input type="text" name="book_publisher" class="form-control" value="${market.bookinfo.book_publisher}" readonly>
				<label for="book_pubdate">출간일</label>
				<input type="text" name="book_pubdate" class="form-control" value="${market.bookinfo.book_pubdate}" readonly>
				<label for="book_description">책 설명</label>
				<input type="text" name="book_description" class="form-control" value="${market.bookinfo.book_description}" readonly>
			</div>				
		   
		    <div class="marketWritePrice marketWriteCon">
		    	<label for="mPrice">가격</label>
		   		<input type="text" class="form-control" name="mPrice" value="${market.MPrice}"/>
		   </div>
		   
		    <div class="marketWriteContent marketWriteCon">
		    	<label for="mContent">내용</label>
		   		<textarea rows="4" cols="100" name="mContent" placeholder="내용" class="form-control">${market.MContent}</textarea>
		   </div>
